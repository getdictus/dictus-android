...
- [ ] **Phase 5: Polish + Differentiators** - Waveform animation, sound feedback, text suggestion bar, emoji picker, light theme, iOS visual parity
...
**Goal**: Users experience premium feedback, convenience features, and visual polish during dictation and typing
**Depends on**: Phase 3
...
Plans:
- [ ] 05-01-PLAN.md — WaveformDriver (iOS BrandWaveformDriver port) + DictationSoundPlayer (SoundPool) + wiring
- [ ] 05-02-PLAN.md — Light/auto theme (ThemeMode enum, DictusLightColorScheme), iOS color alignment, bottom nav pill, model card badge
- [ ] 05-03-PLAN.md — Emoji picker (EmojiPickerView via AndroidView), KeyboardScreen emoji state toggle
- [ ] 05-04-PLAN.md — Text suggestion bar (SuggestionBar + StubSuggestionEngine), InputConnection wiring
...
| 5. Polish + Differentiators | 0/5 | Planning complete | - |
